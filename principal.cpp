  ...
  while (execute) {
    ...
    case 1: {
      ...
      try {
        ...
        DtClase *clase_spinning_ains = new DtSpinning(identificacion_spinning,
            nombre_clase_spinning, turno_clase_spinning, cantidad_bicicletas);
    ...
    case 5:
    {
      ...
      try {
        ...
        std::cout
            << "Ingrese el identificador de la clase a la que se desea desinscribir. \n";
